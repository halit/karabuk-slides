...
\plain{Gerçek Hacker?}{\vspace{-3em}\begin{center}\includegraphics[width=\textwidth, height=3.2in]{babanne.jpeg}\end{center}}
...
\plain{Python?}{\vspace{-3em}\begin{center}\includegraphics[width=\textwidth, height=3.2in]{pyjava.jpg}\end{center}}
